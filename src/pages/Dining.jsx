...
const DINING_VENUES = [
  {
    ...
    highlights: ['À la carte menu', 'Private dining room', 'Wine cellar', 'Open 24 hours'],
  },
]
...
const BAR_SECTIONS = [
  {
    ...
    highlights: ['Signature cocktails', 'Premium spirits', 'Air-conditioned lounge', 'Open 24 hours'],
  },
  {
    name: 'Poolside Bar',
    ...
    highlights: ['Cocktail bar', 'Poolside seating', 'Light bites', 'Open 24 hours'],
  },
  {
    name: 'Roof Top Bar',
    ...
    highlights: ['Panoramic views', 'Signature cocktails', 'Live music Fri–Sat', 'Open 24 hours'],
  },
]
