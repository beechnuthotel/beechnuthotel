...
const SOCIAL_LINKS = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/share/19FgdhN5Pw/',
    path: 'M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z',
  },
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/beechnut.hotels.ltd',
          ...
          <motion.div variants={itemVariants}>
            ...
            <address className="not-italic space-y-3">
              ...
              <div className="flex items-start gap-2 text-sm text-white/55">
                ...
                <a href="mailto:info@beechnuthotel.com" className="hover:text-gold-400 transition-colors">info@beechnuthotel.com</a>
              </div>
            </address>
