...
export default function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-[#25D366] text-[#06381E] rounded-full px-4 py-2.5 shadow-[0_6px_28px_rgba(37,211,102,0.4)] text-sm font-bold no-underline animate-wa-pulse"
      aria-label="Chat with us on WhatsApp"
    >
      <svg viewBox="0 0 32 32" width="22" height="22" fill="#06381E" aria-hidden="true">
